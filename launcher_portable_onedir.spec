...
hiddenimports = [
    ...
    'backend.utils.image_placeholder_utils', 'backend.utils.mineru_layout_utils',
    'backend.utils.format_convert_utils',
    'backend.utils.mixed_formula_text', 'backend.utils.markdown_chunk_merger',
    ...
    'app.services.task', 'app.services.task.batch_manager', 'app.services.version_service',
    ...
    'sse_starlette', 'sse_starlette.sse', 'httpx_sse', 'jwt',
