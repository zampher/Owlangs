!function (e, t) {
    ...
    return function () {
        ...
        var l = {
            ...
            }, getBaseElem: a, isCharacterBox: function (e) {
                const t = a(e);
        ...
        class m {
            constructor(e) {
                ...
                for (const t in h) if (h.hasOwnProperty(t)) {
                    const r = h[t];
        ...
        const u = [new p(0, 0, !1), new p(1, 0, !0), new p(2, 1, !1), new p(3, 1, !0), new p(4, 2, !1), new p(5, 2, !0), new p(6, 3, !1), new p(7, 3, !0)],
            d = [4, 5, 4, 5, 6, 7, 6, 7], g = [5, 5, 5, 5, 7, 7, 7, 7], f = [2, 3, 4, 5, 6, 7, 6, 7],
            b = [3, 3, 5, 5, 7, 7, 7, 7], y = [1, 1, 3, 3, 5, 5, 7, 7], x = [0, 1, 2, 3, 2, 3, 2, 3];
        var w = {DISPLAY: u[0], TEXT: u[2], SCRIPT: u[4], SCRIPTSCRIPT: u[6]};
        const v = [{name: "latin", blocks: [[256, 591], [768, 879]]}, {
            name: "cyrillic",
            blocks: [[1024, 1279]]
        }, {name: "armenian", blocks: [[1328, 1423]]}, {name: "brahmic", blocks: [[2304, 4255]]}, {
            name: "georgian",
            blocks: [[4256, 4351]]
        }, {name: "cjk", blocks: [[12288, 12543], [19968, 40879], [65280, 65376]]}, {
            name: "hangul",
            blocks: [[44032, 55215]]
        }];
        const k = [];
        ...
        function S(e) {
            for (let t = 0; t < k.length; t += 2) if (e >= k[t] && e <= k[t + 1]) return !0;
            return !1
        }
        ...
        const q = {};
        const I = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
            R = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], H = function (e, t) {
        ...
        class O {
            ...
            havingStyle(e) {
                return this.style === e ? this : this.extend({style: e, size: H(this.textSize, e)})
            }
            ...
            fontMetrics() {
                return this._fontMetrics || (this._fontMetrics = function (e) {
                    ...
                    if (t = e >= 5 ? 0 : e >= 3 ? 1 : 2, !q[t]) {
                        const e = q[t] = {cssEmPerMu: B.quad[t] / 18};
        ...
        const L = {
            ...
            sp: 1 / 65536,
            px: 1.00375
        }, D = {ex: !0, em: !0, mu: !0}, V = function (e) {
            return "string" != typeof e && (e = e.unit), e in L || e in D || "ex" === e
        }, P = function (e, t) {
            let r;
            if (e.unit in L) r = L[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier; else if ("mu" === e.unit) r = t.fontMetrics().cssEmPerMu; else {
                let o;
                if (o = t.style.isTight() ? t.havingStyle(t.style.text()) : t, "ex" === e.unit) r = o.fontMetrics().xHeight; else {
        ...
        const re = {bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1},
            ne = {"accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1}, oe = {math: {}, text: {}};
        var se = oe;

        function ie(e, t, r, n, o, s) {
            oe[e][o] = {font: t, group: r, replace: n}, s && n && (oe[e][n] = oe[e][o])
        }

        const ae = "math", le = "text", he = "main", ce = "ams", me = "accent-token", pe = "bin", ue = "close",
            de = "inner", ge = "mathord", fe = "op-token", be = "open", ye = "punct", xe = "rel", we = "spacing",
            ve = "textord";
        ...
        const Be = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathboldfrak", "textboldfrak", "Fraktur-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            ...
            Ne = function (e, t, r) {
                return se[r][e] && se[r][e].replace && (e = se[r][e].replace), {value: e, metrics: N(e, t, r)}
            }, qe = function (e, t, r, n, o) {
                const s = Ne(e, t, r), i = s.metrics;
                let a;
                if (e = s.value, i) {
                    let t = i.italic;
                ...
                return Re(o), o
            }, Oe = (e, t, r, n) => new _(e, t, r, n), Ee = function (e) {
                const t = new A(e);
                return Re(t), t
            }, Le = function (e, t, r) {
                let n, o = "";
        ...
        var Pe = {
            fontMap: De, makeSymbol: qe, mathsym: function (e, t, r, n) {
            ...
            }, makeSpan: He, makeSvgSpan: Oe, makeLineSpan: function (e, t, r) {
                const n = He([e], [], t);
                ...
                return Re(o), o
            }, makeFragment: Ee, wrapFragment: function (e, t) {
                ...
                const {children: r, depth: n} = function (e) {
                    ...
                    return {children: e.children, depth: t}
                }(e);
                let o = 0;
                ...
                for (let e = 0; e < r.length; e++) {
                    ...
                    if ("kern" === t.type) h += t.size; else {
                        const e = t.elem, r = t.wrapperClasses || [], n = t.wrapperStyle || {},
                            a = He(r, [s, e], void 0, n);
                ...
                const o = e.mode, s = e.text, i = ["mord"], a = "math" === o || "text" === o && t.font,
        ...
        const Fe = {number: 3, unit: "mu"}, Ge = {number: 4, unit: "mu"}, Ue = {number: 5, unit: "mu"}, Ye = {
            mord: {mop: Fe, mbin: Ge, mrel: Ue, minner: Fe},
            mop: {mord: Fe, mop: Fe, mrel: Ue, minner: Fe},
            mbin: {mord: Ge, mop: Ge, mopen: Ge, minner: Ge},
            mrel: {mord: Ue, mop: Ue, mopen: Ue, minner: Ue},
            mopen: {},
            mclose: {mop: Fe, mbin: Ge, mrel: Ue, minner: Fe},
            mpunct: {mord: Fe, mop: Fe, mrel: Ue, mopen: Fe, mclose: Fe, mpunct: Fe, minner: Fe},
            minner: {mord: Fe, mop: Fe, mbin: Ge, mrel: Ue, mopen: Fe, mpunct: Fe, minner: Fe}
        }, Xe = {
            mord: {mop: Fe},
            mop: {mord: Fe, mop: Fe},
            mbin: {},
        ...
        function Ze(e) {
            ...
            $e({
                type: t, names: [], props: {numArgs: 0}, handler() {
                    throw new Error("Should never be called.")
                }, htmlBuilder: r, mathmlBuilder: n
            })
        }
        ...
        const Ke = function (e) {
            ...
            }, Qe = Pe.makeSpan, et = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
            tt = ["rightmost", "mrel", "mclose", "mpunct"],
            rt = {display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT}, nt = {
                mord: "mord",
                mop: "mop",
                mbin: "mbin",
                mrel: "mrel",
                ...
                const i = Qe([n[0] || "leftmost"], [], t), a = Qe([n[1] || "rightmost"], [], t), h = "root" === r;
                return st(o, ((e, t) => {
                    const r = t.classes[0], n = e.classes[0];
                    "mbin" === r && l.contains(tt, n) ? t.classes[0] = "mord" : "mbin" === n && l.contains(et, r) && (e.classes[0] = "mord")
                }), {node: i}, a, h), st(o, ((e, t) => {
                    const r = lt(t), n = lt(e), o = r && n ? e.hasClass("mtight") ? Xe[r][n] : Ye[r][n] : null;
        ...
        function mt(e, t) {
            const r = Qe(["base"], e, t), n = Qe(["strut"]);
        ...
        function pt(e, t) {
            ...
            const s = [];
            let i, a = [];
            for (let e = 0; e < n.length; e++) if (a.push(n[e]), n[e].hasClass("mbin") || n[e].hasClass("mrel") || n[e].hasClass("allowbreak")) {
                let r = !1;
        ...
        class dt {
            ...
            toNode() {
                ...
                for (let t = 0; t < this.children.length; t++) if (this.children[t] instanceof gt && this.children[t + 1] instanceof gt) {
        ...
        var ft = {
            MathNode: dt, TextNode: gt, SpaceNode: class {
                constructor(e) {
        ...
        function Mt(e, t, r, n, o) {
            ...
            const h = new ft.MathNode("semantics", [i, a]), c = new ft.MathNode("math", [h]);
        ...
        var Nt = function (e, t, r, n, o) {
            ...
            if (/fbox|color|angl/.test(t)) {
                ...
                const r = new J(e, {width: "100%", height: F(i)});
            ...
            const {span: r, minWidth: n, height: o} = function () {
                ...
                if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                    ...
                    let i, a, l;
                    if (s > 5) "widehat" === n || "widecheck" === n ? (i = 420, r = 2364, l = .42, a = n + "4") : (i = 312, r = 2340, l = .34, a = "tilde4"); else {
                ...
                }
                {
                    ...
                    for (let n = 0; n < h; n++) {
                        const o = new Q(s[n]), p = new J([o], {
                            width: "400em",
                            height: F(l),
                            viewBox: "0 0 " + r + " " + a,
                            preserveAspectRatio: m[n] + " slice"
                        }), u = Pe.makeSvgSpan([c[n]], [p], t);
                        if (1 === h) return {span: u, minWidth: i, height: l};
        ...
        const Et = (e, t) => {
                ...
                if (n.isStretchy) h = It(n, t), h = Pe.makeVList({
                    ...
                    children: [{type: "elem", elem: s}, {
                        ...
                        wrapperStyle: i > 0 ? {width: "calc(100% - " + F(2 * i) + ")", marginLeft: F(2 * i)} : void 0
                    }]
                }, t); else {
                    let e, r;
                    ...
                    o || (l -= r / 2), h.style.left = F(l), "\\textcircled" === n.label && (h.style.top = ".2em"), h = Pe.makeVList({
                        positionType: "firstBaseline",
                        children: [{type: "elem", elem: s}, {type: "kern", size: -c}, {type: "elem", elem: h}]
                    }, t)
                }
        ...
        $e({
            ...
            props: {numArgs: 1},
            handler: (e, t) => {
                const r = Ke(t[0]), n = !Dt.test(e.funcName),
                    o = !n || "\\widehat" === e.funcName || "\\widetilde" === e.funcName || "\\widecheck" === e.funcName;
                return {type: "accent", mode: e.parser.mode, label: e.funcName, isStretchy: n, isShifty: o, base: r}
            },
            htmlBuilder: Et,
            mathmlBuilder: Lt
        }), $e({
            ...
            htmlBuilder: (e, t) => {
                const r = ct(e.base, t), n = It(e, t), o = "\\utilde" === e.label ? .12 : 0, s = Pe.makeVList({
                    positionType: "top",
            ...
            mathmlBuilder: (e, t) => {
                const r = qt(e.label), n = new ft.MathNode("munder", [St(e.base, t), r]);
        ...
        $e({
            ...
            handler(e, t, r) {
                ...
                return {type: "xArrow", mode: n.mode, label: o, body: t[0], below: r[0]}
            },
            htmlBuilder(e, t) {
                const r = t.style;
                let n = t.havingStyle(r.sup());
                const o = Pe.wrapFragment(ct(e.body, n, t), t), s = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                let i;
                o.classes.push(s + "-arrow-pad"), e.below && (n = t.havingStyle(r.sub()), i = Pe.wrapFragment(ct(e.below, n, t), t), i.classes.push(s + "-arrow-pad"));
                const a = It(e, t), l = -t.fontMetrics().axisHeight + .5 * a.height;
                ...
                if ((o.depth > .25 || "\\xleftequilibrium" === e.label) && (c -= o.depth), i) {
                    ...
                    h = Pe.makeVList({
                        ...
                        children: [{type: "elem", elem: o, shift: c}, {type: "elem", elem: a, shift: l}, {
                            type: "elem",
                            elem: i,
                            shift: e
                        }]
        ...
        $e({
            type: "mclass", names: ["\\@binrel"], props: {numArgs: 2}, handler(e, t) {
                let {parser: r} = e;
                return {
                    type: "mclass",
                    mode: r.mode,
            ...
            type: "mclass", names: ["\\stackrel", "\\overset", "\\underset"], props: {numArgs: 2}, handler(e, t) {
                let {parser: r, funcName: n} = e;
                const o = t[1], s = t[0];
                let i;
                ...
                return {type: "mclass", mode: r.mode, mclass: i, body: [h], isCharacterBox: l.isCharacterBox(h)}
            }, htmlBuilder: Ft, mathmlBuilder: Gt
        }), $e({
            type: "pmb", names: ["\\pmb"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                let {parser: r} = e;
                return {type: "pmb", mode: r.mode, mclass: Ut(t[0]), body: Je(t[0])}
            }, htmlBuilder(e, t) {
                const r = ot(e.body, t, !0), n = Pe.makeSpan([e.mclass], r, t);
                return n.style.textShadow = "0.02em 0.01em 0.04px", n
            }, mathmlBuilder(e, t) {
                const r = vt(e.body, t), n = new ft.MathNode("mstyle", r);
        ...
        function Wt(e, t, r) {
            ...
            switch (n) {
                ...
                case"\\uparrow":
                case"\\downarrow": {
                    const e = {type: "atom", text: n, mode: "math", family: "rel"}, o = {
                        type: "ordgroup",
                        mode: "math",
        ...
        $e({
            type: "cdlabel", names: ["\\\\cdleft", "\\\\cdright"], props: {numArgs: 1}, handler(e, t) {
                let {parser: r, funcName: n} = e;
                return {type: "cdlabel", mode: r.mode, side: n.slice(4), label: t[0]}
            }, htmlBuilder(e, t) {
                const r = t.havingStyle(t.style.sup()), n = Pe.wrapFragment(ct(e.label, r, t), t);
            ...
            type: "cdlabelparent", names: ["\\\\cdparent"], props: {numArgs: 1}, handler(e, t) {
                let {parser: r} = e;
            ...
            type: "textord", names: ["\\@char"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                let {parser: r} = e;
        ...
        const _t = (e, t) => {
            ...
            const r = vt(e.body, t.withColor(e.color)), n = new ft.MathNode("mstyle", r);
        ...
        $e({
            ...
            handler(e, t) {
                let {parser: r} = e;
                const n = Rt(t[0], "color-token").color, o = t[1];
                return {type: "color", mode: r.mode, color: n, body: Je(o)}
            },
            htmlBuilder: _t,
            mathmlBuilder: jt
        }), $e({
            ...
            handler(e, t) {
                ...
                return {type: "color", mode: r.mode, color: o, body: s}
            },
            htmlBuilder: _t,
            mathmlBuilder: jt
        }), $e({
            ...
            handler(e, t, r) {
                ...
                return {type: "cr", mode: n.mode, newLine: s, size: o && Rt(o, "size").value}
            },
            htmlBuilder(e, t) {
        ...
        $e({
            ...
            handler(e) {
                let {parser: t, funcName: r} = e, o = t.gullet.popToken();
                const s = o.text;
                ...
                return i && h.unshift(i), "\\edef" !== r && "\\xdef" !== r || (h = t.gullet.expandTokens(h), h.reverse()), t.gullet.macros.set(s, {
                    ...
                    numArgs: a,
                    delimiters: l
                }, r === $t[r]), {type: "internal", mode: t.mode}
            }
        }), $e({
            type: "internal",
            names: ["\\let", "\\\\globallet"],
            ...
            handler(e) {
                ...
                return Kt(t, n, o, "\\\\globallet" === r), {type: "internal", mode: t.mode}
            }
        }), $e({
            type: "internal",
            ...
            handler(e) {
                let {parser: t, funcName: r} = e;
                const n = Zt(t.gullet.popToken()), o = t.gullet.popToken(), s = t.gullet.popToken();
        ...
        const Jt = function (e, t, r) {
                ...
                const o = r.havingBaseStyle(t), s = Pe.makeSpan(n.concat(o.sizingClasses(r)), [e], r),
                ...
                }(e, t, o, n), a = Qt(Pe.makeSpan(["delimsizing", "size" + t], [i], n), w.TEXT, n, s);
                ...
                return i.height = t, i.style.height = F(t), i.style.width = F(n), {type: "elem", elem: i}
            }, or = {type: "kern", size: -.008}, sr = ["|", "\\lvert", "\\rvert", "\\vert"],
            ir = ["\\|", "\\lVert", "\\rVert", "\\Vert"], ar = function (e, t, r, n, o, s) {
                let i, a, h, c, m = "", p = 0;
                i = h = c = e, a = null;
                let u = "Size1-Regular";
                ...
                const d = Jt(i, u, o), g = d.height + d.depth, f = Jt(h, u, o), b = f.height + f.depth, y = Jt(c, u, o),
                    x = y.height + y.depth;
                let v = 0, k = 1;
                if (null !== a) {
                    const e = Jt(a, u, o);
                ...
                const S = g + x + v, M = S + Math.max(0, Math.ceil((t - S) / (k * b))) * k * b;
                let z = n.fontMetrics().axisHeight;
                r && (z *= n.sizeMultiplier);
                const A = M / 2 - z, T = [];
                if (m.length > 0) {
                    const e = M - g - x, t = Math.round(1e3 * M), r = function (e, t) {
                            switch (e) {
                                case"lbrack":
                        ...
                        }(m, Math.round(1e3 * e)), o = new Q(m, r), s = (p / 1e3).toFixed(3) + "em",
                        i = (t / 1e3).toFixed(3) + "em",
                        a = new J([o], {width: s, height: i, viewBox: "0 0 " + p + " " + t}),
                        l = Pe.makeSvgSpan([], [a], n);
                    l.height = t / 1e3, l.style.width = s, l.style.height = i, T.push({type: "elem", elem: l})
                } else {
                ...
                const B = n.havingBaseStyle(w.TEXT),
                    C = Pe.makeVList({positionType: "bottom", positionData: A, children: T}, B);
                return Qt(Pe.makeSpan(["delimsizing", "mult"], [C], B), w.TEXT, n, s)
            }, lr = .08, hr = function (e, t, r, n, o) {
            ...
            pr = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], ur = [0, 1.2, 1.8, 2.4, 3],
            dr = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            gr = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "stack"}], fr = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], br = function (e) {
                ...
                return "small" === a.type ? function (e, t, r, n, o, s) {
                    const i = Pe.makeSymbol(e, "Main-Regular", o, n), a = Qt(i, t, n, s);
                    return r && er(a, n, t), a
                }(e, a.style, r, n, o, s) : "large" === a.type ? tr(e, a.size, r, n, o, s) : ar(e, t, r, n, o, s)
            };
        var wr = {
            sqrtImage: function (e, t) {
                const r = t.havingBaseSizing(), n = yr("\\surd", e * r.sizeMultiplier, fr, r);
            ...
            }, sizeToMaxHeight: ur, customSizedDelim: xr, leftRightDelim: function (e, t, r, n, o, s) {
                const i = n.fontMetrics().axisHeight * n.sizeMultiplier, a = 5 / n.fontMetrics().ptPerEm,
                    l = Math.max(t - i, r + i), h = Math.max(l / 500 * 901, 2 * l - a);
        ...
        $e({
            ...
            type: "leftright-right", names: ["\\right"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                ...
                return {type: "leftright-right", mode: e.parser.mode, delim: Sr(t[0], e).text, color: r}
            }
        }), $e({
            type: "leftright", names: ["\\left"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                const r = Sr(t[0], e), n = e.parser;
                ++n.leftrightDepth;
                const o = n.parseExpression(!1);
                --n.leftrightDepth, n.expect("\\right", !1);
                const s = Rt(n.parseFunction(), "leftright-right");
                return {type: "leftright", mode: n.mode, body: o, left: r.text, right: s.delim, rightColor: s.color}
            }, htmlBuilder: (e, t) => {
                Mr(e);
                ...
                if (s *= t.sizeMultiplier, i *= t.sizeMultiplier, n = "." === e.left ? ht(t, ["mopen"]) : wr.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"]), r.unshift(n), a) for (let t = 1; t < r.length; t++) {
                    const n = r[t].isMiddle;
                    n && (r[t] = wr.leftRightDelim(n.delim, s, i, n.options, e.mode, []))
                }
                if ("." === e.right) o = ht(t, ["mclose"]); else {
            ...
            type: "middle", names: ["\\middle"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                const r = Sr(t[0], e);
        ...
        const zr = (e, t) => {
            const r = Pe.wrapFragment(ct(e.body, t), t), n = e.label.slice(1);
            let o, s = t.sizeMultiplier, i = 0;
            const a = l.isCharacterBox(e.body);
            if ("sout" === n) o = Pe.makeSpan(["stretchy", "sout"]), o.height = t.fontMetrics().defaultRuleThickness / s, i = -.5 * t.fontMetrics().xHeight; else if ("phase" === n) {
                const e = P({number: .6, unit: "pt"}, t), n = P({number: .35, unit: "ex"}, t);
            ...
            if (e.backgroundColor) c = Pe.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: o, shift: i}, {type: "elem", elem: r, shift: 0}]
            }, t); else {
                const e = /cancel|phase/.test(n) ? ["svg-align"] : [];
                c = Pe.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: r, shift: 0}, {type: "elem", elem: o, shift: i, wrapperClasses: e}]
                }, t)
            }
        ...
        $e({
            ...
            handler(e, t, r) {
                let {parser: n, funcName: o} = e;
                const s = Rt(t[0], "color-token").color, i = t[1];
                return {type: "enclose", mode: n.mode, label: o, backgroundColor: s, body: i}
            },
            htmlBuilder: zr,
            mathmlBuilder: Ar
        }), $e({
            ...
            handler(e, t, r) {
                let {parser: n, funcName: o} = e;
                const s = Rt(t[0], "color-token").color, i = Rt(t[1], "color-token").color, a = t[2];
                return {type: "enclose", mode: n.mode, label: o, backgroundColor: i, borderColor: s, body: a}
            },
            htmlBuilder: zr,
            mathmlBuilder: Ar
        }), $e({
            ...
            handler(e, t) {
                let {parser: r, funcName: n} = e;
                const o = t[0];
                return {type: "enclose", mode: r.mode, label: n, body: o}
            },
            htmlBuilder: zr,
            mathmlBuilder: Ar
        }), $e({
        ...
        function Br(e) {
            let {type: t, names: r, props: n, handler: o, htmlBuilder: s, mathmlBuilder: i} = e;
            const a = {type: t, numArgs: n.numArgs || 0, allowedInText: !1, numOptionalArgs: 0, handler: o};
        ...
        function Er(e, t, r) {
            ...
            if (e.gullet.beginGroup(), c || e.gullet.macros.set("\\cr", "\\\\\\relax"), !a) {
                ...
                if (null == t) a = 1; else if (a = parseFloat(t), !a || a < 0) throw new n("Invalid \\arraystretch: " + t)
            }
            e.gullet.beginGroup();
            let d = [];
            const g = [d], f = [], b = [], y = null != h ? [] : void 0;
            ...
            for (x(), b.push(Rr(e)); ;) {
                ...
                e.gullet.endGroup(), e.gullet.beginGroup(), t = {
                    ...
                    mode: e.mode,
                    body: t
                }, r && (t = {type: "styling", mode: e.mode, style: r, body: [t]}), d.push(t);
        ...
        const Dr = function (e, t) {
            ...
            let a = 0, h = new Array(s);
            const c = [], m = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness),
            ...
            const d = "CD" === e.colSeparationType ? P({number: 3, unit: "ex"}, t) : 12 * p, g = 3 * p,
                f = e.arraystretch * d, b = .7 * f, y = .3 * f;
            let x = 0;

            function v(e) {
                for (let t = 0; t < e.length; ++t) t > 0 && (x += .25), c.push({pos: x, isDashed: e[t]})
            }
            ...
            const k = x / 2 + t.fontMetrics().axisHeight, S = e.cols || [], M = [];
            let z, A;
            const T = [];
            if (e.tags && e.tags.some((e => e))) for (r = 0; r < s; ++r) {
            ...
            if (h = Pe.makeSpan(["mtable"], M), c.length > 0) {
                const e = Pe.makeLineSpan("hline", t, m), r = Pe.makeLineSpan("hdashline", t, m),
                    n = [{type: "elem", elem: h, shift: 0}];
                for (; c.length > 0;) {
        ...
        }, Vr = {c: "center ", l: "left ", r: "right "}, Pr = function (e, t) {
            const r = [], n = new ft.MathNode("mtd", [], ["mtr-glue"]), o = new ft.MathNode("mtd", [], ["mml-eqn-num"]);
            ...
            const r = [], o = e.envName.indexOf("at") > -1 ? "alignat" : "align", s = "split" === e.envName,
                i = Er(e.parser, {
                    cols: r,
                    addJot: !0,
            ...
            let a, l = 0;
            const h = {type: "ordgroup", mode: e.mode, body: []};
        ...
        Br({
            type: "array", names: ["array", "darray"], props: {numArgs: 1}, handler(e, t) {
                ...
                })), o = {cols: r, hskipBeforeAndAfter: !0, maxNumCols: r.length};
                return Er(e.parser, o, Lr(e.envName))
            }, htmlBuilder: Dr, mathmlBuilder: Pr
        }), Br({
            type: "array",
            ...
            handler(e) {
                ...
                const s = Er(e.parser, o, Lr(e.envName)), i = Math.max(0, ...s.body.map((e => e.length)));
                return s.cols = new Array(i).fill({type: "align", align: r}), t ? {
                    type: "leftright",
                    mode: e.mode,
                    body: [s],
                    left: t[0],
            ...
            type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler(e) {
                const t = Er(e.parser, {arraystretch: .5}, "script");
                return t.colSeparationType = "small", t
            }, htmlBuilder: Dr, mathmlBuilder: Pr
        }), Br({
            type: "array", names: ["subarray"], props: {numArgs: 1}, handler(e, t) {
                const r = (Ot(t[0]) ? [t[0]] : Rt(t[0], "ordgroup").body).map((function (e) {
                    const t = Ht(e).text;
                ...
                let o = {cols: r, hskipBeforeAndAfter: !1, arraystretch: .5};
                if (o = Er(e.parser, o, "script"), o.body.length > 0 && o.body[0].length > 1) throw new n("{subarray} can contain only one column");
                return o
            }, htmlBuilder: Dr, mathmlBuilder: Pr
        }), Br({
            type: "array", names: ["cases", "dcases", "rcases", "drcases"], props: {numArgs: 0}, handler(e) {
                const t = Er(e.parser, {
                    arraystretch: 1.2,
            ...
            type: "array", names: ["gathered", "gather", "gather*"], props: {numArgs: 0}, handler(e) {
            ...
            type: "array", names: ["equation", "equation*"], props: {numArgs: 0}, handler(e) {
                Hr(e);
                const t = {
                    autoTag: Or(e.envName),
                    emptySingleRow: !0,
            ...
            type: "array", names: ["CD"], props: {numArgs: 0}, handler(e) {
                return Hr(e), function (e) {
                    ...
                    for (let a = 0; a < t.length; a++) {
                        ...
                        for (let t = 0; t < l.length; t++) if (Xt(l[t])) {
                            r.push(h), t += 1;
                            const o = Ht(l[t]).text, a = new Array(2);
                            if (a[0] = {type: "ordgroup", mode: "math", body: []}, a[1] = {
                                type: "ordgroup",
                                mode: "math",
                                body: []
                            }, "=|.".indexOf(o) > -1) ; else {
                    ...
                    return e.gullet.endGroup(), e.gullet.endGroup(), {
                        ...
                        addJot: !0,
                        rowGaps: [null],
                        cols: new Array(o[0].length).fill({type: "align", align: "c", pregap: .25, postgap: .25}),
        ...
        var Gr = Tr;
        $e({
            type: "environment", names: ["\\begin", "\\end"], props: {numArgs: 1, argTypes: ["text"]}, handler(e, t) {
                ...
                if ("\\begin" === o) {
                    ...
                    const e = Gr[i], {args: t, optArgs: o} = r.parseArguments("\\begin{" + i + "}", e),
                        a = {mode: r.mode, envName: i, parser: r}, l = e.handler(a, t, o);
                    r.expect("\\end", !1);
        ...
        $e({
            ...
            handler: (e, t) => {
                ...
                const o = Ke(t[0]);
                let s = n;
                return s in Xr && (s = Xr[s]), {type: "font", mode: r.mode, font: s.slice(1), body: o}
            },
            htmlBuilder: Ur,
            mathmlBuilder: Yr
        }), $e({
            type: "mclass", names: ["\\boldsymbol", "\\bm"], props: {numArgs: 1}, handler: (e, t) => {
                let {parser: r} = e;
                const n = t[0], o = l.isCharacterBox(n);
                return {
                    type: "mclass",
                    mode: r.mode,
                    mclass: Ut(n),
            ...
            handler: (e, t) => {
                ...
                const {mode: s} = r, i = r.parseExpression(!0, o);
                return {
                    type: "font",
                    mode: s,
                    font: "math" + n.slice(1),
                    body: {type: "ordgroup", mode: r.mode, body: i}
                }
            },
            htmlBuilder: Ur,
            mathmlBuilder: Yr
        ...
        const Wr = (e, t) => {
            ...
            const r = Wr(e.size, t.style), n = r.fracNum(), o = r.fracDen();
            let s;
            s = t.havingStyle(n);
            ...
            if (e.hasBarLine ? (e.barSize ? (h = P(e.barSize, t), l = Pe.makeLineSpan("frac-line", t, h)) : l = Pe.makeLineSpan("frac-line", t), h = l.height, c = l.height) : (l = null, h = 0, c = t.fontMetrics().defaultRuleThickness), r.size === w.DISPLAY.size || "display" === e.size ? (m = t.fontMetrics().num1, p = h > 0 ? 3 * c : 7 * c, u = t.fontMetrics().denom1) : (h > 0 ? (m = t.fontMetrics().num2, p = c) : (m = t.fontMetrics().num3, p = 3 * c), u = t.fontMetrics().denom2), l) {
                ...
                d = Pe.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: a, shift: u}, {type: "elem", elem: l, shift: r}, {
                        type: "elem",
                        elem: i,
                        shift: -m
                    }]
                ...
                e < p && (m += .5 * (p - e), u += .5 * (p - e)), d = Pe.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: a, shift: u}, {type: "elem", elem: i, shift: -m}]
                }, t)
            }
        ...
        $e({
            ...
            type: "genfrac", names: ["\\cfrac"], props: {numArgs: 2}, handler: (e, t) => {
                let {parser: r, funcName: n} = e;
                const o = t[0], s = t[1];
                return {
                    type: "genfrac",
        ...
        const $r = ["display", "text", "script", "scriptscript"], Zr = function (e) {
            let t = null;
        ...
        $e({
            ...
            handler(e, t) {
                let {parser: r} = e;
                const n = t[4], o = t[5], s = Ke(t[0]),
                    i = "atom" === s.type && "open" === s.family ? Zr(s.text) : null, a = Ke(t[1]),
                    l = "atom" === a.type && "close" === a.family ? Zr(a.text) : null, h = Rt(t[2], "size");
                let c, m = null;
            ...
            type: "infix", names: ["\\above"], props: {numArgs: 1, argTypes: ["size"], infix: !0}, handler(e, t) {
            ...
            handler: (e, t) => {
                let {parser: r, funcName: n} = e;
                const o = t[0], s = function (e) {
                    if (!e) throw new Error("Expected non-null, but got " + String(e));
                    return e
                }(Rt(t[1], "infix").size), i = t[2], a = s.number > 0;
                return {
                    type: "genfrac",
                    mode: r.mode,
                    numer: o,
        ...
        const Kr = (e, t) => {
            ...
            const s = ct(o.base, t.havingBaseStyle(w.DISPLAY)), i = It(o, t);
            let a;
            if (o.isOver ? (a = Pe.makeVList({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: s}, {type: "kern", size: .1}, {type: "elem", elem: i}]
            }, t), a.children[0].children[0].children[1].classes.push("svg-align")) : (a = Pe.makeVList({
                positionType: "bottom",
                positionData: s.depth + .1 + i.height,
                children: [{type: "elem", elem: i}, {type: "kern", size: .1}, {type: "elem", elem: s}]
                ...
                a = o.isOver ? Pe.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: e}, {type: "kern", size: .2}, {type: "elem", elem: n}]
                }, t) : Pe.makeVList({
                    positionType: "bottom",
                    positionData: e.depth + .2 + n.height + n.depth,
                    children: [{type: "elem", elem: n}, {type: "kern", size: .2}, {type: "elem", elem: e}]
                }, t)
            }
            return Pe.makeSpan(["mord", o.isOver ? "mover" : "munder"], [a], t)
        };
        $e({
            type: "horizBrace", names: ["\\overbrace", "\\underbrace"], props: {numArgs: 1}, handler(e, t) {
                let {parser: r, funcName: n} = e;
                return {type: "horizBrace", mode: r.mode, label: n, isOver: /^\\over/.test(n), base: t[0]}
            }, htmlBuilder: Kr, mathmlBuilder: (e, t) => {
                const r = qt(e.label);
            ...
            handler: (e, t) => {
                let {parser: r} = e;
                const n = t[1], o = Rt(t[0], "url").url;
                return r.settings.isTrusted({command: "\\href", url: o}) ? {
                    type: "href",
                    mode: r.mode,
                    href: o,
                    body: Je(n)
            ...
            handler: (e, t) => {
                ...
                const s = {type: "text", mode: r.mode, font: "\\texttt", body: o};
                return {type: "href", mode: r.mode, href: n, body: Je(s)}
            }
        }), $e({
            type: "hbox",
            names: ["\\hbox"],
            ...
            handler(e, t) {
                let {parser: r} = e;
                return {type: "hbox", mode: r.mode, body: Je(t[0])}
            },
            htmlBuilder(e, t) {
                const r = ot(e.body, t, !1);
                return Pe.makeFragment(r)
            ...
            handler: (e, t) => {
                ...
                const i = Rt(t[0], "raw").string, a = t[1];
                let l;
            ...
            htmlBuilder: (e, t) => {
                const r = ot(e.body, t, !1), n = ["enclosing"];
            ...
            handler: (e, t) => {
                let {parser: r} = e;
                return {type: "htmlmathml", mode: r.mode, html: Je(t[0]), mathml: Je(t[1])}
            },
            htmlBuilder: (e, t) => {
        ...
        $e({
            ...
            handler: (e, t, r) => {
                let {parser: o} = e, s = {number: 0, unit: "em"}, i = {number: .9, unit: "em"},
                    a = {number: 0, unit: "em"}, l = "";
                if (r[0]) {
            ...
            handler(e, t) {
                ...
                return n.expect(s), n.switchMode(o), {type: "styling", mode: n.mode, style: "text", body: i}
            }
        }), $e({
            type: "text",
            names: ["\\)", "\\]"],
        ...
        $e({
            type: "mathchoice", names: ["\\mathchoice"], props: {numArgs: 4, primitive: !0}, handler: (e, t) => {
                let {parser: r} = e;
                return {
                    type: "mathchoice",
                    mode: r.mode,
        ...
        const en = (e, t, r, n, o, s, i) => {
            ...
            if (c && h) {
                ...
                m = Pe.makeVList({
                    positionType: "bottom",
                    positionData: t,
                    children: [{type: "kern", size: n.fontMetrics().bigOpSpacing5}, {
                        type: "elem",
                        elem: h.elem,
                        marginLeft: F(-s)
                    }, {type: "kern", size: h.kern}, {type: "elem", elem: e}, {
                        type: "kern",
                        size: c.kern
                    }, {type: "elem", elem: c.elem, marginLeft: F(s)}, {
                        type: "kern",
                ...
                if (!c) return e;
                {
                    ...
                    m = Pe.makeVList({
                        positionType: "bottom",
                        positionData: t,
                        children: [{type: "elem", elem: e}, {type: "kern", size: c.kern}, {
                            type: "elem",
                            elem: c.elem,
                            marginLeft: F(s)
            ...
            if (i.size === w.DISPLAY.size && o.symbol && !l.contains(tn, o.name) && (h = !0), o.symbol) {
                ...
                if ("\\oiint" !== o.name && "\\oiiint" !== o.name || (r = o.name.slice(1), o.name = "oiint" === r ? "\\iint" : "\\iiint"), a = Pe.makeSymbol(o.name, e, "math", t, ["mop", "op-symbol", h ? "large-op" : "small-op"]), r.length > 0) {
                    const e = a.italic, n = Pe.staticSvg(r + "Size" + (h ? "2" : "1"), t);
                    a = Pe.makeVList({
                        positionType: "individualShift",
                        children: [{type: "elem", elem: a, shift: 0}, {type: "elem", elem: n, shift: h ? .08 : 0}]
            ...
            let r;
            if (e.symbol) r = new dt("mo", [bt(e.name, e.mode)]), l.contains(tn, e.name) && r.setAttribute("largeop", "false"); else if (e.body) r = new dt("mo", vt(e.body, t)); else {
        ...
        $e({
            ...
            type: "op", names: ["\\mathop"], props: {numArgs: 1, primitive: !0}, handler: (e, t) => {
                let {parser: r} = e;
                const n = t[0];
                return {type: "op", mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: Je(n)}
        ...
        $e({
            ...
            handler(e) {
                let {parser: t, funcName: r} = e;
                return {type: "op", mode: t.mode, limits: !1, parentIsSupSub: !1, symbol: !1, name: r}
            },
            htmlBuilder: rn,
            mathmlBuilder: nn
        }), $e({
            ...
            handler(e) {
                let {parser: t, funcName: r} = e;
                return {type: "op", mode: t.mode, limits: !0, parentIsSupSub: !1, symbol: !1, name: r}
            },
            htmlBuilder: rn,
            mathmlBuilder: nn
        }), $e({
        ...
        function ln(e, t, r) {
            const n = ot(e, t, !1), o = t.sizeMultiplier / r.sizeMultiplier;
            for (let e = 0; e < n.length; e++) {
        ...
        $e({
            ...
            htmlBuilder: an,
            mathmlBuilder: (e, t) => {
                let r = vt(e.body, t.withFont("mathrm")), n = !0;
                for (let e = 0; e < r.length; e++) {
                    const t = r[e];
                    if (t instanceof ft.SpaceNode) ; else if (t instanceof ft.MathNode) switch (t.type) {
                        case"mi":
                        case"mn":
                        case"ms":
                        case"mspace":
            ...
            type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler(e, t) {
                let {parser: r} = e;
                const n = t[0];
                return {type: "overline", mode: r.mode, body: n}
            }, htmlBuilder(e, t) {
                const r = ct(e.body, t.havingCrampedStyle()), n = Pe.makeLineSpan("overline-line", t),
                    o = t.fontMetrics().defaultRuleThickness, s = Pe.makeVList({
                        positionType: "firstBaseline",
                        children: [{type: "elem", elem: r}, {type: "kern", size: 3 * o}, {
                            type: "elem",
                            elem: n
                        }, {type: "kern", size: o}]
                    }, t);
            ...
            type: "phantom", names: ["\\phantom"], props: {numArgs: 1, allowedInText: !0}, handler: (e, t) => {
                let {parser: r} = e;
                const n = t[0];
                return {type: "phantom", mode: r.mode, body: Je(n)}
            }, htmlBuilder: (e, t) => {
            ...
            type: "hphantom", names: ["\\hphantom"], props: {numArgs: 1, allowedInText: !0}, handler: (e, t) => {
                let {parser: r} = e;
                const n = t[0];
                return {type: "hphantom", mode: r.mode, body: n}
            }, htmlBuilder: (e, t) => {
                let r = Pe.makeSpan([], [ct(e.body, t.withPhantom())]);
                if (r.height = 0, r.depth = 0, r.children) for (let e = 0; e < r.children.length; e++) r.children[e].height = 0, r.children[e].depth = 0;
                return r = Pe.makeVList({
                    positionType: "firstBaseline",
                    children: [{type: "elem", elem: r}]
                }, t), Pe.makeSpan(["mord"], [r], t)
            }, mathmlBuilder: (e, t) => {
                const r = vt(Je(e.body), t), n = new ft.MathNode("mphantom", r), o = new ft.MathNode("mpadded", [n]);
                return o.setAttribute("height", "0px"), o.setAttribute("depth", "0px"), o
            }
        }), $e({
            type: "vphantom", names: ["\\vphantom"], props: {numArgs: 1, allowedInText: !0}, handler: (e, t) => {
                let {parser: r} = e;
                const n = t[0];
                return {type: "vphantom", mode: r.mode, body: n}
            }, htmlBuilder: (e, t) => {
                const r = Pe.makeSpan(["inner"], [ct(e.body, t.withPhantom())]), n = Pe.makeSpan(["fix"], []);
            ...
            handler(e, t) {
                let {parser: r} = e;
                const n = Rt(t[0], "size").value, o = t[1];
                return {type: "raisebox", mode: r.mode, dy: n, body: o}
            },
            htmlBuilder(e, t) {
                const r = ct(e.body, t), n = P(e.dy, t);
                return Pe.makeVList({positionType: "shift", positionData: -n, children: [{type: "elem", elem: r}]}, t)
            },
            mathmlBuilder(e, t) {
                const r = new ft.MathNode("mpadded", [St(e.body, t)]), n = e.dy.number + e.dy.unit;
            ...
            handler(e, t, r) {
                let {parser: n} = e;
                const o = r[0], s = Rt(t[0], "size"), i = Rt(t[1], "size");
                return {type: "rule", mode: n.mode, shift: o && Rt(o, "size").value, width: s.value, height: i.value}
            },
            htmlBuilder(e, t) {
                const r = Pe.makeSpan(["mord", "rule"], [], t), n = P(e.width, t), o = P(e.height, t),
            ...
            mathmlBuilder(e, t) {
                const r = P(e.width, t), n = P(e.height, t), o = e.shift ? P(e.shift, t) : 0,
                    s = t.color && t.getColor() || "black", i = new ft.MathNode("mspace");
        ...
        $e({
            type: "sizing", names: hn, props: {numArgs: 0, allowedInText: !0}, handler: (e, t) => {
                let {breakOnTokenText: r, funcName: n, parser: o} = e;
                const s = o.parseExpression(!1, r);
                return {type: "sizing", mode: o.mode, size: hn.indexOf(n) + 1, body: s}
            }, htmlBuilder: (e, t) => {
                const r = t.havingSize(e.size);
                return ln(e.body, r, t)
            }, mathmlBuilder: (e, t) => {
                const r = t.havingSize(e.size), n = vt(e.body, r), o = new ft.MathNode("mstyle", n);
            ...
            handler: (e, t, r) => {
                ...
                const a = t[0];
                return {type: "smash", mode: n.mode, body: a, smashHeight: o, smashDepth: s}
            },
            htmlBuilder: (e, t) => {
                ...
                const n = Pe.makeVList({positionType: "firstBaseline", children: [{type: "elem", elem: r}]}, t);
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler(e, t, r) {
                let {parser: n} = e;
                const o = r[0], s = t[0];
                return {type: "sqrt", mode: n.mode, body: s, index: o}
            }, htmlBuilder(e, t) {
                ...
                let s = n + o / 4;
                const i = r.height + r.depth + s + n, {span: a, ruleWidth: l, advanceWidth: h} = wr.sqrtImage(i, t),
                    c = a.height - l;
                ...
                const p = Pe.makeVList({
                    ...
                    children: [{type: "elem", elem: r, wrapperClasses: ["svg-align"]}, {
                        type: "kern",
                        size: -(r.height + m)
                    }, {type: "elem", elem: a}, {type: "kern", size: l}]
                }, t);
                if (e.index) {
                    const r = t.havingStyle(w.SCRIPTSCRIPT), n = ct(e.index, r, t), o = .6 * (p.height - p.depth),
                        s = Pe.makeVList({
                            positionType: "shift",
                            positionData: -o,
                            children: [{type: "elem", elem: n}]
                        }, t), i = Pe.makeSpan(["root"], [s]);
        ...
        $e({
            ...
            handler(e, t) {
                ...
                return {type: "styling", mode: o.mode, style: i, body: s}
            },
            htmlBuilder(e, t) {
                const r = cn[e.style], n = t.havingStyle(r).withFont("");
                return ln(e.body, n, t)
            },
            mathmlBuilder(e, t) {
                const r = cn[e.style], n = t.havingStyle(r), o = vt(e.body, n), s = new ft.MathNode("mstyle", o), i = {
                    display: ["0", "true"],
                    text: ["0", "false"],
                    script: ["1", "false"],
        ...
        Ze({
            type: "supsub", htmlBuilder(e, t) {
                ...
                if (r) return r(e, t);
                const {base: n, sup: o, sub: s} = e, i = ct(n, t);
                let a, h;
                ...
                const g = t.sizeMultiplier, f = F(.5 / c.ptPerEm / g);
                let b, y = null;
                if (h) {
                ...
                if (a && h) {
                    ...
                    const r = [{type: "elem", elem: h, shift: p, marginRight: f, marginLeft: y}, {
                        type: "elem",
                        elem: a,
                        shift: -m,
                        marginRight: f
                    ...
                    m = Math.max(m, d, a.depth + .25 * c.xHeight), b = Pe.makeVList({
                        positionType: "shift",
                        positionData: -m,
                        children: [{type: "elem", elem: a, marginRight: f}]
                    }, t)
                }
                ...
                const s = [St(e.base, t)];
                let i;
                if (e.sub && s.push(St(e.sub, t)), e.sup && s.push(St(e.sup, t)), o) i = r ? "mover" : "munder"; else if (e.sub) if (e.sup) {
                    const r = e.base;
        ...
        Ze({
            type: "mathord", htmlBuilder(e, t) {
                return Pe.makeOrd(e, t, "mathord")
            }, mathmlBuilder(e, t) {
                const r = new ft.MathNode("mi", [bt(e.text, e.mode, t)]), n = xt(e, t) || "italic";
                return n !== mn[r.type] && r.setAttribute("mathvariant", n), r
            }
        }), Ze({
            type: "textord", htmlBuilder(e, t) {
                return Pe.makeOrd(e, t, "textord")
            }, mathmlBuilder(e, t) {
                const r = bt(e.text, e.mode, t), n = xt(e, t) || "normal";
                let o;
        ...
        const pn = {"\\nobreak": "nobreak", "\\allowbreak": "allowbreak"}, un = {
            " ": {},
            "\\ ": {},
            "~": {className: "nobreak"},
            "\\space": {},
        ...
        const gn = {
                ...
                "\\texttt": "texttt",
                "\\textnormal": "textrm"
            }, fn = {"\\textbf": "textbf", "\\textmd": "textmd"}, bn = {"\\textit": "textit", "\\textup": "textup"},
            yn = (e, t) => {
                const r = e.font;
        ...
        $e({
            ...
            handler(e, t) {
                let {parser: r, funcName: n} = e;
                const o = t[0];
                return {type: "text", mode: r.mode, body: Je(o), font: n}
            },
            htmlBuilder(e, t) {
                const r = yn(e, t), n = ot(e.body, r, !0);
            ...
            type: "underline", names: ["\\underline"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                let {parser: r} = e;
                return {type: "underline", mode: r.mode, body: t[0]}
            }, htmlBuilder(e, t) {
                const r = ct(e.body, t), n = Pe.makeLineSpan("underline-line", t),
                    o = t.fontMetrics().defaultRuleThickness, s = Pe.makeVList({
                        positionType: "top",
                        positionData: r.height,
                        children: [{type: "kern", size: o}, {type: "elem", elem: n}, {
                            type: "kern",
                            size: 3 * o
                        }, {type: "elem", elem: r}]
                    }, t);
            ...
            htmlBuilder(e, t) {
                const r = ct(e.body, t), n = t.fontMetrics().axisHeight, o = .5 * (r.height - n - (r.depth + n));
                return Pe.makeVList({positionType: "shift", positionData: o, children: [{type: "elem", elem: r}]}, t)
            },
            mathmlBuilder(e, t) {
                return new ft.MathNode("mpadded", [St(e.body, t)], ["vcenter"])
            }
        }), $e({
            type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler(e, t, r) {
                throw new n("\\verb ended by end of line instead of matching delimiter")
            }, htmlBuilder(e, t) {
                const r = xn(e), n = [], o = t.havingStyle(t.style.text());
                ...
                const r = new ft.TextNode(xn(e)), n = new ft.MathNode("mtext", [r]);
                return n.setAttribute("mathvariant", "monospace"), n
            }
        });
        const xn = e => e.body.replace(/ /g, e.star ? "\u2423" : "\xa0");
        var wn = We;
        const vn = "[ \r\n\t]", kn = "(\\\\[a-zA-Z@]+)" + vn + "*", Sn = "[\u0300-\u036f]", Mn = new RegExp(Sn + "+$"),
        ...
        Nr("\\noexpand", (function (e) {
            ...
            e.consumeSpaces();
            const r = e.future();
            return 1 === t[0].length && t[0][0].text === r.text ? {tokens: t[1], numArgs: 0} : {
                tokens: t[2],
                numArgs: 0
            }
        ...
        Nr("\\char", (function (e) {
            ...
            if ("'" === r.text) t = 8, r = e.popToken(); else if ('"' === r.text) t = 16, r = e.popToken(); else if ("`" === r.text) if (r = e.popToken(), "\\" === r.text[0]) o = r.text.charCodeAt(1); else {
        ...
        const Nn = (e, t, r, o) => {
            ...
            if (s = e.consumeArg().tokens, 1 === s.length && "[" === s[0].text) {
                ...
                for (; "]" !== r.text && "EOF" !== r.text;) t += r.text, r = e.expandNextToken();
        ...
        const Hn = e => t => {
            const r = t.consumeArg().tokens, n = t.consumeArg().tokens, o = t.consumeArg().tokens,
                s = t.consumeArg().tokens, i = t.macros.get("|"), a = t.macros.get("\\|");
            t.macros.beginGroup();
            const l = t => r => {
        ...
        class En {
            ...
            consumeArg(e) {
                ...
                do {
                    ...
                    if (e && r) if ((0 === i || 1 === i && "{" === e[a]) && s.text === e[a]) {
                        if (++a, a === e.length) {
                            t.splice(-a, a);
                            break
                        }
            ...
            expandOnce(e) {
                const t = this.popToken(), r = t.text, o = t.noexpand ? null : this._getExpansion(r);
        ...
        class Fn {
            ...
            formatUnsupportedCmd(e) {
                const t = [];
                for (let r = 0; r < e.length; r++) t.push({type: "textord", mode: "text", text: e[r]});
                const r = {type: "text", mode: this.mode, body: t};
                return {type: "color", mode: this.mode, color: this.settings.errorColor, body: [r]}
            }
                ...
                for (; ;) {
                    ...
                    if ("\\limits" === e.text || "\\nolimits" === e.text) {
                        ...
                        if (!Dn[e.text]) break;
                        {
                            ...
                            t ? o = {type: "ordgroup", mode: "math", body: s} : r = {
                                type: "ordgroup",
                                mode: "math",
                                body: s
                            }
            ...
            parseFunction(e, t) {
                const r = this.fetch(), o = r.text, s = wn[o];
                if (!s) return null;
            ...
            callFunction(e, t, r, o, s) {
                const i = {funcName: e, parser: this, token: o, breakOnTokenText: s}, a = wn[e];
            ...
            parseStringGroup(e, t) {
                ...
                let n, o = "";
                for (; "EOF" !== (n = this.fetch()).text;) o += n.text, this.consume();
            ...
            parseRegexGroup(e, t) {
                const r = this.fetch();
                let o, s = r, i = "";
                for (; "EOF" !== (o = this.fetch()).text && e.test(i + o.text);) s = o, i += s.text, this.consume();
            ...
            parseSizeGroup(e) {
                ...
                const s = {number: +(o[1] + o[2]), unit: o[3]};
                if (!V(s)) throw new n("Invalid unit: '" + s.unit + "'", t);
                return {type: "size", mode: this.mode, value: s, isBlank: r}
            }
            ...
            parseArgumentGroup(e, t) {
                ...
                const s = {type: "ordgroup", mode: this.mode, loc: r.loc, body: o};
                return t && this.switchMode(n), s
            }

            parseGroup(e, t) {
                const r = this.fetch(), o = r.text;
                let s;
                if ("{" === o || "\\begingroup" === o) {
                    this.consume();
                    const e = "{" === o ? "}" : "\\endgroup";
            ...
            parseSymbol() {
                ...
                if (r && (t = t.substring(0, r.index), "i" === t ? t = "\u0131" : "j" === t && (t = "\u0237")), se[this.mode][t]) {
                    ...
                    const r = se[this.mode][t].group, n = qr.range(e);
                    let s;
                    if (re.hasOwnProperty(r)) {
                        const e = r;
                        s = {type: "atom", mode: this.mode, family: e, loc: n, text: t}
                    } else s = {type: r, mode: this.mode, loc: n, text: t};
                    o = s
                } else {
                ...
                if (this.consume(), r) for (let t = 0; t < r[0].length; t++) {
                    const s = r[0][t];
        ...
        var Wn = {
            ...
            __renderToHTMLTree: function (e, t) {
                ...
                try {
                    return function (e, t, r) {
                        const n = pt(e, zt(r)), o = Pe.makeSpan(["katex"], [n]);
                        return At(o, r)
                    }(Gn(e, r), 0, r)
                } catch (t) {
                    return Yn(t, e, r)
            ...
            __defineFunction: $e,
            __defineMacro: Nr,
            __domTree: {Span: _, Anchor: j, SymbolNode: K, SvgNode: J, PathNode: Q, LineNode: ee}
        };
        return t = t.default
    }()
}));